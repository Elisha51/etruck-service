                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">e-Truck Service</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Smart transportation starts here 🚀</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ url('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                              ...
                              @endif
                                ...
                                <select name="role" id="" class="form-control" autofocus>
                            ...
                            <div class="mb-3">
                              ...
                              @endif
                                ...
                                <input type="text" class="form-control" id="username" name="contact"
